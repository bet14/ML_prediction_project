"""
Fetch USA GDP release history from FRED.
...
Output
------
    data/raw/macro/USA_gdp.csv — columns: date, realtime_start, value.
    Raw release history; no forward-fill or transform (that's process_gdp.py).

Usage
-----
    python fetch_usa_gdp.py --verify-only
    python fetch_usa_gdp.py --start 2013-01-01 --end 2024-12-31
"""
